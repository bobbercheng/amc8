...
*[Diagram shows a pyramid of boxes:*
- *Top row: 6, 5, ?*
- *Middle row: 30, ?*
- *Bottom row: 600]*
...
$\textbf{(A)}\ \frac{1}{4} \qquad \textbf{(B)}\ \frac{1}{3} \qquad \textbf{(C)}\ \frac{3}{8} \qquad \textbf{(D)}\ \frac{1}{2} \qquad \textbf{(E)}\ \frac{2}{3}$
...
*[Diagram shows a 3D rectangular fort with dimensions labeled: 12 feet long, 10 feet wide, 5 feet high, with hollow interior]*
...
$\textbf{(A)}\ \frac{\pi}{2} \qquad \textbf{(B)}\ \frac{2\pi}{3} \qquad \textbf{(C)}\ \pi \qquad \textbf{(D)}\ \frac{4\pi}{3} \qquad \textbf{(E)}\ \frac{5\pi}{3}$
...
*[Diagram shows a partial grid made of toothpicks with dots indicating continuation]*
...
*[Diagram shows right triangle ABC with semicircles drawn on each side, with the semicircles facing outward from the triangle]*
...
*[Diagram shows three equal squares arranged with EFGH on the bottom left, GHIJ on the bottom right sharing side GH, and ABCD positioned above with C at midpoint of IH and D at midpoint of HE. Pentagon AJICB is shaded.]*
...
*[Diagram shows a track made of three semicircular arcs: first arc (R₁=100) curves downward, second arc (R₂=60) curves upward, third arc (R₃=80) curves downward. A ball starts at point A on the left and ends at point B on the right.]*
