...
*[Diagram shows a 4×4 grid with an eight-pointed star pattern formed by triangular shapes, some shaded darker and some lighter]*
...
*[Image shows hieroglyphs representing a number]*
...
*[Diagram shows an 8×6 grid with points F at (6,5), A at (7,3), B at (0,0), and C at (2,4)]*
...
*[Diagram shows a cube and its unfolded net]*
...
*[Diagram shows a clock face with a dashed line connecting 4 and 10]*
...
*[Diagram shows the original rectangle ABCD and the rotated rectangle with the midpoint of DC marked]*
...
*[Diagram shows the five tetromino shapes: I (4 in a row), O (2×2 square), L (L-shape), T (T-shape), S (S-shape), and a 3×4 rectangle]*
...
*[Diagram shows a cross-shaped region made of 24 unit squares arranged in a diamond/plus pattern]*
...
*[Five histograms labeled (A) through (E) showing different distributions of remainders 0-6]*
...
*[Diagram shows a 6×6 grid with a dashed vertical line through the middle]*
...
*[Diagram shows three nodes A, B, C with directed arrows between them labeled with fractions: A→B: 1/4, B→A: 1/3, B→C: 1/6, C→B: 1/10, C→A: 1/8, A→C: 1/5]*
...
*[Diagram shows two circles: left circle has radius 1 with fully shaded region between circle and inscribed square; right circle has radius R with only one quarter of that region shaded]*
...
*[Diagram shows a road divided into three 5-mile segments with speed limits 25, 40, and 20 mph from A to B]*
...
*[Diagram shows 7 pods (A-G) connected by walkways in a network pattern, with C, E, and F highlighted]*
...
*[Diagram shows a row of coat hooks with some coats hanging]*
...
*[Diagram shows isosceles trapezoid ABCD with angles B and C marked as 60°, and tick marks indicating AB = DC]*
...
*[Diagram shows two examples of paths on a 5×5 diamond grid, with shaded areas of 11 and 13 square units respectively]*
