...
**Test Date:** Tuesday, November 17, 2015  
...
*[Diagram shows a regular octagon ABCDEFGH with center O. Point X is the midpoint of side AB. The region bounded by X-B-C-D-E-O is shaded.]*
...
*[Diagram shows a cube with vertices labeled A, B, C, D, E, F, G, H]*
...
*[Diagram shows a 5×5 grid with corner values: top-left = 1, top-right = 25, bottom-left = 17, bottom-right = 81. The center square is labeled X.]*
...
*[Diagram shows a coordinate grid with triangle ABC plotted on it]*
...
*[Diagram shows an equiangular hexagon ABCDEF with squares ABJI (area 18) and FEHG (area 32) attached. Triangle JBK is equilateral and connected to point C.]*
...
*[Diagram shows a 5-inch square with 1-inch squares cut from each of the four corners (shaded gray)]*
