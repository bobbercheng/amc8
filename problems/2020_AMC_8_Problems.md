...
*[Diagram shows three hexagons with dots: first has 1 dot, second has 7 dots (1 center + 6 around), third has 19 dots (adding another ring of 12)]*
...
*[Diagram shows a 4×4×4 cube made of unit cubes]*
...
*[Graph shows distance (miles) vs time (minutes). Maya's journey (solid line) takes 30 minutes with stops. Naomi's journey (dashed line) takes about 10 minutes total.]*
...
*[Bar chart showing 20 cities with varying population heights, with a dashed horizontal line indicating the average around 4750]*
...
*[Diagram shows 6 points labeled A through F with 5 lines passing through various combinations of points]*
...
*[Diagram shows a semicircle with diameter FE, and rectangle ABCD inscribed with D and A on the diameter, B and C on the semicircle. DA = 16, FD = AE = 9]*
...
*[Diagram shows an 8×8 checkerboard with P marked in the bottom row and Q in the top row, with a sample path shown using circles]*
...
*[Diagram shows a machine: if N is even, output N/2; if N is odd, output 3N+1]*
...
$$N \to \_\_\_ \to \_\_\_ \to \_\_\_ \to \_\_\_ \to \_\_\_ \to 1$$
...
*[Diagram shows a 3×3 grid of gray square tiles with white borders between and around them]*
...
*[Diagram shows rectangles R₁, R₂ and squares S₁, S₂, S₃ arranged to form a large rectangle. R₁ is in bottom left, S₃ is in bottom right, S₂ is in the middle, S₁ is in upper left, and R₂ is in upper right]*
