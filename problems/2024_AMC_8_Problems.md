...
*[Diagram shows four nested squares aligned at bottom-left corner, alternating white and gray]*
...
*[Diagram shows four different skating paths on an ice rink]*
...
*[Diagram shows the three tile types]*
...
*[Diagram shows triangle ABC on coordinate plane]*
...
*[Diagram shows a bunny and stairs]*
...
*[Diagram shows a directed graph with nodes A, M, X, Y, C, Z and weighted edges:*
- *A to M: 8*
- *A to X: 5*
- *X to M: 2*
- *X to Y: 10*
...
*[Diagram shows a 3×3 grid with king K in center and arrows pointing to all 8 surrounding squares]*
...
*[Diagram shows three concentric circles with shaded regions]*
...
*[Diagram shows a cube with vertices labeled P, Q, R, S, T, U, V, W]*
...
*[Diagram shows cross-section of tape roll with outer diameter 4 inches and inner diameter 2 inches]*
...
*[Diagram shows a line segment from (0,4) to (2,0) with 4 shaded grid cells]*
...
*[Diagram shows two triangular mountain shapes with heights 8 and 12, meeting at height h]*
...
*[Diagram shows a 4×3 grid of seats]*
