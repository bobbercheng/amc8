...
*[Diagram shows a 12-sided polygon drawn on graph paper with vertices at grid points]*
...
*[Bar graph showing: 1 day = 1 student, 2 days = 3 students, 3 days = 2 students, 4 days = 6 students, 5 days = 8 students, 6 days = 3 students, 7 days = 2 students]*
...
*[Diagram shows a large circle with two smaller circles inside it. The smaller circles are tangent to each other at the center of the large circle, and each has its diameter along a radius of the large circle. The shaded region is the part of the large circle not covered by the smaller circles.]*
...
*[Diagram shows a pyramid with 4 levels. Bottom row: +, -, +, -. Second row: -, -, -. Third row: +, +. Top: +]*
...
In $\triangle ABC,$ point $E$ is on $\overline{AB}$ with $AE=1$ and $EB=2.$ Point $D$ is on $\overline{AC}$ so that $\overline{DE} \parallel \overline{BC}$ and point $F$ is on $\overline{BC}$ so that $\overline{EF} \parallel \overline{AC}.$ What is the ratio of the area of $CDEF$ to the area of $\triangle ABC?$

*[Diagram shows triangle ABC with point E on AB (AE=1, EB=2), point D on AC with DE parallel to BC, and point F on BC with EF parallel to AC, forming quadrilateral CDEF]*

$\textbf{(A) } \frac{4}{9} \qquad \textbf{(B) } \frac{1}{2} \qquad \textbf{(C) } \frac{5}{9} \qquad \textbf{(D) } \frac{3}{5} \qquad \textbf{(E) } \frac{2}{3}$

---

## Problem 21 (Number Theory)
...
*[Diagram shows square ABCD with E as the midpoint of CD, line BE intersecting diagonal AC at point F]*
...
*[Diagram shows a regular octagon with vertices marked as dots]*
...
*[Diagram shows a cube with vertices labeled A through H, with J as midpoint of FB and I as midpoint of HD. The cross-section EJCI is shaded.]*

$\textbf{(A) } \frac{5}{4} \qquad \textbf{(B) } \frac{4}{3} \qquad \textbf{(C) } \frac{3}{2} \qquad \textbf{(D) } \frac{25}{16} \qquad \textbf{(E) } \frac{9}{4}$

---

## Problem 25 (Number Theory)
