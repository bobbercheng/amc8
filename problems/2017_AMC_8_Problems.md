...
*[Pie chart showing: Colby 25%, Alicia 45%, Brenda 30%]*
...
*[Diagram shows right triangle ABC with right angle at A, where AC = 3, AB = 4, and BC = 5]*
...
*[Diagram shows non-convex quadrilateral ABCD with vertices labeled]*
...
## Problem 20 (Counting & Probability)
...
*[Diagram shows right triangle ABC with AC = 12 (horizontal), BC = 5 (vertical), and a semicircle inscribed with its diameter on AC]*

$\textbf{(A) }\frac{7}{6}\qquad\textbf{(B) }\frac{13}{5}\qquad\textbf{(C) }\frac{59}{18}\qquad\textbf{(D) }\frac{10}{3}\qquad\textbf{(E) }\frac{60}{13}$

---

## Problem 23 (Arithmetic)
...
## Problem 24 (Counting & Probability)
...
*[Diagram shows a region bounded by two line segments US and UT of length 2 meeting at angle 60°, and two circular arcs each being one-sixth of a circle with radius 2, meeting at point R]*
